        ...
        try {
            ...
            if ($request->hasfile('p_assets_document')) {
                foreach ($request->file('p_assets_document') as $file) {
                    $name = time() . '_' . $file->getClientOriginalName();
                    // Store the file and get the path
                    $filePath = $file->storeAs('public/uploads/assets/assets_document', $name);
                    // Add the path to the array
                    $thumbnailImage[] = $name;
                }
            }
            ...
            if ($request->hasfile('p_purchase_document')) {
                foreach ($request->file('p_purchase_document') as $file) {
                    $name = time() . '_' . $file->getClientOriginalName();
                    // Store the file and get the path
                    $filePath = $file->storeAs('public/uploads/assets/purchase_document', $name);
                    // Add the path to the array
                    $thumbnailImage[] = $name;
                }
            }
            ...
            if ($request->hasfile('p_insurance_document')) {
                foreach ($request->file('p_insurance_document') as $file) {
                    $name = time() . '_' . $file->getClientOriginalName();
                    // Store the file and get the path
                    $filePath = $file->storeAs('public/uploads/assets/insurance_document', $name);
                    // Add the path to the array
                    $thumbnailImage[] = $name;
                }
            }
